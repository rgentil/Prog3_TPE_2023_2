...
public class TestPrimerEntrega {
	...
	public static void main(String[] args) {
		...
		System.out.println("Existe v�rtice 8 ?: " + g.contieneVertice(8));
		System.out.println("Existe v�rtice 7 ?: " + g.contieneVertice(7));

		System.out.println("Agrego nuevamente v�rtice 2");
		g.agregarVertice(2);
		System.out.println("Cantidad de vertices: " + g.cantidadVertices());
		System.out.println("Cantidad de arcos: " + g.cantidadArcos());

		System.out.println("Agrego v�rtice 9");
		g.agregarVertice(9);
		...
		System.out.println("Obtener V�rtices: deber�a retornar del 1 al 9, menos el 8: ");
		...
		try {
			...
			System.out.println("ERROR: Probablemente en vez de un iterador vac�o est�n retornando null.");
		}
		...
		try {
			...
			System.out.println(
					"ERROR: El obtener arco no retorna el arco 2->6 o retorna el arco prototipo que no tiene etiqueta");
		}
		...
		System.out.println("Agrego el v�rtice 12");
		g.agregarVertice(12);
		...
		System.out.println("Cantidad de arcos: " + g.cantidadArcos());
		System.out.println("Vuelvo a agregar arco 9->6: 296 (no deber�a cambiar la cantidad de arcos)");
